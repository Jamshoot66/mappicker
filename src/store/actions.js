...
export const EDIT_MISSION = 'EDIT_MISSION'; //@deprecated TODO: delete me
...
export const SET_CURRENT_SCHEDULE_DATE = 'SET_CURRENT_SCHEDULE_DATE'; //@deprecated TODO: delete me
...
// prettier-ignore
export const SHOW_EDIT_MISSION_COMPONENT_TOGGLE = "SHOW_EDIT_MISSION_COMPONENT_TOGGLE";
// prettier-ignore
...
export async function getAllMissions(dispatch) {
  ...
  if (firebase.auth().currentUser != null) {
    await firebase
      ...
      .then(async token => {
        await fetch(
          firebaseConst.FUNCTIONS_URL_BASE + firebaseConst.GET_MISSIONS,
          {
            credentials: 'include',
            method: 'GET',
            headers: {
...
export async function getAllSchedule(dispatch) {
  if (firebase.auth().currentUser != null) {
    await firebase
      ...
      .then(async token => {
        await fetch(
          firebaseConst.FUNCTIONS_URL_BASE + firebaseConst.GET_SCHEDULE,
          {
            credentials: 'include',
            method: 'GET',
            headers: {
...
export async function addMissionToServer(dispatch, payload) {
  return firebase
    ...
    .then(token => {
      return fetch(
        firebaseConst.FUNCTIONS_URL_BASE + firebaseConst.ADD_MISSION,
        {
          credentials: 'include',
          method: 'POST',
          headers: {
...
export async function updateMissionOnServer(payload) {
  return firebase
    ...
    .then(token => {
      return fetch(
        firebaseConst.FUNCTIONS_URL_BASE + firebaseConst.UPDATE_MISSION,
        {
          credentials: 'include',
          method: 'POST',
          headers: {
...
export async function addScheduleToServer(dispatch, payload) {
  return firebase
    ...
    .then(token => {
      return fetch(
        firebaseConst.FUNCTIONS_URL_BASE + firebaseConst.ADD_SCHEDULE,
        {
          credentials: 'include',
          method: 'POST',
          headers: {
