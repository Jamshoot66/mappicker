  ...
  render() {
    return (
      <section className={`${style.wrapper} ${style.header}`}>
        ...
        <div
          className={`${style.mods}`}
          onClick={() => {
            this.sort(this.sortByMods);
          }}
        >
          Моды
        </div>
        ...
        <div
          className={style.lastPlayed}
          onClick={() => {
            this.sort(this.sortByLastPlayed);
          }}
        >
          Отыгрыш
        </div>
        ...
        {this.props.user.rights.canRate ? (
          <div
            className={style.rateAvg}
            onClick={() => {
              this.sort(this.sortByRateAvg);
            }}
          >
            Рейтинг
          </div>
        ...
        {this.props.user.rights.canRate ? (
          <div
            className={style.probability}
            onClick={() => {
              this.sort(this.sortByProbability);
            }}
          >
            %
          </div>
